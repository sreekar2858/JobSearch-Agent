"""
Extract job URLs from LinkedIn search results pages.
"""
...
class JobLinksExtractor:
    """Extracts job links from LinkedIn search results."""
    ...
    def extract_job_links_from_cards(self, job_cards, current_page: int) -> set:
        """
        ...
        for card in job_cards:
            ...
            try:
                ...
                link_elements = []
                try:
                    link_elements = card.find_elements(By.CSS_SELECTOR, ", ".join(JOB_LINK_SELECTORS))
                ...
                try:
                    ...
                    for next_button in next_buttons:
                        if (
                            ...
                            new_pagination_info = self.get_pagination_info()
